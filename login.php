...
<body onload="myFun()">
	...
	<header>
		...
		<div class="social jello animated">
				<p>Follow Us</p>
				<ul>
	...
	<div class="form fadeInDown animated">
		<img src="user.jpg">
	<form method="get" action="patient/patient_home.php">
		<div class="form-input">
			Username : <input type="text" name="name" value="" placeholder="Enter Username" required/>
		</div>
		<div class="form-input">
			Password  : <input type="password" name="pass" placeholder="Enter the Password" required />
		</div>
