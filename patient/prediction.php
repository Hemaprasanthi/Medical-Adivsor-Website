...
<html>
<head>
	<title>Patient Medicine Prediction</title>
...
<body onload="myFun()">
	...
	<header>
	 <div class="head">
		<div class="logo zoomInLeft animated">
	...
	<div class="form fadeInUpBig animated">
		<form method="post">
			<label>Symptoms : </label>&nbsp;&nbsp;<input type="text" name="name"><br>
		...
		<?php
			...
			include('../dbconnect.php');
				...
				if($_SERVER["REQUEST_METHOD"] == "POST"){
					$symptoms=$_POST['name'];
					 $query="select *from disease where symptoms='$symptoms'";
					...
					{
						echo '<br><br>You have : '.$row['disease'].'<br>';
						echo 'You should take : '.$row['medicine'].'<br>';
						echo 'Prescribed Usage : '.$row['prescribed'].'<br>';
					}
				}
		?>
