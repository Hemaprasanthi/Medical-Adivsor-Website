...
<body onload="myFun()">
	<div id="loader"></div>
			<div id="mydiv" style="display:none;">
				...
				<h1 class="doctor fadeInRight animated">Welcome  <?php echo $nameval; ?></h1>
				</div>

						<div class="doctor fadeInUp animated">
						<?php
								...
								$query="select *from doctor";
											...
											if(isset($_GET['del'])){
													$del_id=$_GET['del'];
													if(mysql_query("delete from doctor where sno = '$del_id'")){
														echo "deleted";
													}
													else{
														echo 'not deleted';
				...
				<input type="text" class="fadeInLeft animated" id="myInput" onkeyup="myFunction()" placeholder="Search for DoctorID's.." title="Type in a name">
							<?php
								$p=1;
								...
								while($row=mysql_fetch_array($run))
											{
												...
												echo "<td><a href='admin_doctor_details.php?del=".$row['sno']."'><button>Delete</button></td>";
												echo "</tr>";
